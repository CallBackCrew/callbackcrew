...
import ServiceDetailsImage from '../../assets/images/resource/service-details1.jpeg';
                                    ...
                                    <div className="service-sidebar wow fadeInUp" data-wow-delay="0.1s" data-wow-duration="1200m">
                                        <div className="service-list">
                                            <ul>
                                                ...
                                                <li>
                                                    <Link to="/service-details1" className="current">
                                                        <i className="fas fa-angle-right"></i>
                                    ...
                                    <ul className="accordion-box wow fadeInRight">
                                        <li className={`accordion block ${showQues === 1 ? 'active-block' : ''}`} onClick={() => openQuestion(1)}>
                                            ...
                                            <div className={`acc-content ${showQues === 1 ? 'current' : ''}`}>
                                                <div className="content">
                                                    <div className="text">Good UI/UX design improves user satisfaction, increases engagement, reduces bounce rates, and can lead to better conversion rates. It helps users easily navigate your product and keeps them coming back.
                                        ...
                                        <li className={`accordion block active-block ${showQues === 2 ? 'active-block' : ''}`} onClick={() => openQuestion(2)}>
                                            <div className={`acc-btn ${showQues === 2 ? 'active' : ''}`}>
                                                How does good UI/UX design impact user experience and conversions?
                                                <div className="icon fa fa-plus"></div>
                                            </div>
                                            <div className={`acc-content ${showQues === 2 ? 'current' : ''}`}>
                                                <div className="content">
                                                    <div className="text">An intuitive and appealing design makes it easier for users to find what they need, trust your brand, and complete actions—like signing up or making a purchase—leading to increased conversions and loyalty.</div>
                                                </div>
                                            </div>
                                        </li>
                                        <li className={`accordion block active-block ${showQues === 3 ? 'active-block' : ''}`} onClick={() => openQuestion(3)}>
                                            ...
                                            <div className={`acc-content ${showQues === 3 ? 'current' : ''}`}>
                                                <div className="content">
                                                    <div className="text">We use industry-standard tools like Figma, Adobe XD, Sketch, and InVision for design, prototyping, and collaboration. For user testing and feedback, we may also use tools like Maze or UsabilityHub.
                                        ...
                                        <li className={`accordion block active-block ${showQues === 4 ? 'active-block' : ''}`} onClick={() => openQuestion(4)}>
                                            ...
                                            <div className={`acc-content ${showQues === 4 ? 'current' : ''}`}>
                                                <div className="content">
                                                    <div className="text">Our process includes research, wireframing, prototyping, visual design, usability testing, and final delivery. We work closely with clients at every stage to ensure the design aligns with their goals and user needs.</div>
                                                </div>
                                            </div>
                                        </li>
                                    </ul>
