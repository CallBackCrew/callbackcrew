                    ...
                    <div className="row">
                                    ...
                                    <div className="service-sidebar wow fadeInUp" data-wow-delay="0.1s" data-wow-duration="1200m">
                                        <div className="service-list">
                                            <ul>
                                                ...
                                                <li>
                                                    <Link to="/service-details2" className="current">
                                                        <i className="fas fa-angle-right"></i>
                        ...
                        <div className="col-xl-8 col-lg-8">
                            <div className="services-details__content">
                                ...
                                <p> We harness data to strengthen your business decisions. With precise analysis, detailed reports, and actionable insights, we optimize performance and shape effective future strategies.</p>
