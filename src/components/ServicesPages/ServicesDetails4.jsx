...
import ServiceDetailsImage from '../../assets/images/resource/service-details4.jpeg';
                    ...
                    <div className="row">
                                    ...
                                    <div className="service-sidebar wow fadeInUp" data-wow-delay="0.1s" data-wow-duration="1200m">
                                        <div className="service-list">
                                            <ul>
                                                ...
                                                <li>
                                                    <Link  to="/service-details4" className="current">
                                                        <i className="fas fa-angle-right"></i>
                        ...
                        <div className="col-xl-8 col-lg-8">
                            <div className="services-details__content">
                                ...
                                <p>  We build responsive, high-performance websites tailored to your needs. From design to deployment, we create seamless, scalable, and secure websites that enhance your online presence.</p>
                                    ...
                                    <ul className="accordion-box wow fadeInRight">
                                        <li className={`accordion block ${showQues === 1 ? 'active-block' : ''}`} onClick={() => openQuestion(1)}>
                                            ...
                                            <div className={`acc-content ${showQues === 1 ? 'current' : ''}`}>
                                                <div className="content">
                                                    <div className="text">Front-end development involves everything users see and interact with (e.g., layout, design, buttons). Back-end development focuses on the server-side logic, databases, and performance behind the scenes.</div>
                                                </div>
                                            </div>
                                        </li>
                                        <li className={`accordion block active-block ${showQues === 2 ? 'active-block' : ''}`} onClick={() => openQuestion(2)}>
                                            ...
                                            <div className={`acc-content ${showQues === 2 ? 'current' : ''}`}>
                                                <div className="content">
                                                    <div className="text">We use modern technologies like HTML, CSS, JavaScript, React, Node.js, PHP, Python (Django), MySQL, MongoDB, and frameworks like Laravel and Express.js, depending on your project needs.
                                        ...
                                        <li className={`accordion block active-block ${showQues === 3 ? 'active-block' : ''}`} onClick={() => openQuestion(3)}>
                                            ...
                                            <div className={`acc-content ${showQues === 3 ? 'current' : ''}`}>
                                                <div className="content">
                                                    <div className="text">We can do both! For custom needs, we build from scratch. For faster or budget-friendly projects, we can use and customize templates or CMS platforms like WordPress.</div>
                                                </div>
                                            </div>
                                        </li>
                                        <li className={`accordion block active-block ${showQues === 4 ? 'active-block' : ''}`} onClick={() => openQuestion(4)}>
                                            <div className={`acc-btn ${showQues === 4 ? 'active' : ''}`}>
                                               Is your web development service mobile-friendly?

                                                <div className="icon fa fa-plus"></div>
                                            </div>
                                            <div className={`acc-content ${showQues === 4 ? 'current' : ''}`}>
                                                <div className="content">
                                                    <div className="text">Yes, we ensure that all websites we build are responsive, meaning they work smoothly on desktops, tablets, and smartphones.</div>
                                                </div>
                                            </div>
                                        </li>
                                    </ul>
...
export default ServicesDetails4;
